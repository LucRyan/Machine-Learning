class MyBaseGameCrowdAgent extends CrowdAgentBase
	native
	abstract
...
var MyBaseGameCrowdAgent MyArchetype;
...
/**
  ...
  */
simulated function InitializeAgent( Actor SpawnLoc, const out array<CrowdSpawnerPlayerInfo> PlayerInfo, MyBaseGameCrowdAgent AgentTemplate, GameCrowdGroup NewGroup, float AgentWarmUpTime, bool bWarmupPosition, bool bCheckWarmupVisibility )
{
